  ...
  "/vue3/": [
    {
      ...
      items: [
        ...
        {
          link: "/vue3/treeshaking",
          text: "说说Vue 3.0中Treeshaking特性？举例说明一下？",
        },
        {
          link: "/vue3/modal_component",
  ...
  "/js/": [
    {
      ...
      items: [
        ...
        { link: "/js/array_api", text: "数组的常用方法有哪些？" },
        { link: "/js/string_api", text: "JavaScript字符串的常用方法有哪些？" },
        {
          link: "/js/type_conversion",
          text: "谈谈 JavaScript 中的类型转换机制",
        },
        { link: "/js/== _===", text: "== 和 ===区别，分别在什么情况使用" },
        { link: "/js/copy", text: "深拷贝浅拷贝的区别？如何实现一个深拷贝？" },
        { link: "/js/closure", text: "说说你对闭包的理解？闭包使用场景" },
        { link: "/js/scope", text: "说说你对作用域链的理解" },
        {
          link: "/js/prototype",
          text: "JavaScript原型，原型链 ? 有什么特点？",
        },
        { link: "/js/inherit", text: "Javascript如何实现继承？" },
        { link: "/js/this", text: "谈谈this对象的理解" },
        {
          link: "/js/context_stack",
          text: "JavaScript中执行上下文和执行栈是什么？",
        },
        { link: "/js/event_Model", text: "说说JavaScript中的事件模型" },
        { link: "/js/typeof_instanceof", text: "typeof 与 instanceof 区别" },
        { link: "/js/event_agent", text: "解释下什么是事件代理？应用场景？" },
        { link: "/js/new", text: "说说new操作符具体干了什么？" },
        { link: "/js/ajax", text: "ajax原理是什么？如何实现？" },
        {
          link: "/js/bind_call_apply",
          text: "bind、call、apply 区别？如何实现一个bind?",
        },
        { link: "/js/regexp", text: "说说你对正则表达式的理解？应用场景？" },
        { link: "/js/event_loop", text: "说说你对事件循环的理解" },
        { link: "/js/Dom", text: "DOM常见的操作有哪些？" },
        {
          link: "/js/BOM",
          text: "说说你对BOM的理解，常见的BOM对象你了解哪些？",
        },
        {
          link: "/js/tail_recursion",
        ...
        {
          link: "/js/functional_programming",
          text: "说说你对函数式编程的理解？优缺点？",
        },
        {
          link: "/js/function_cache",
          text: "Javascript中如何实现函数缓存？函数缓存有哪些应用场景？",
        },
        {
          link: "/js/loss_accuracy",
          text: "说说 Javascript 数字精度丢失的问题，如何解决？",
        },
        {
          link: "/js/debounce_throttle",
          text: "什么是防抖和节流？有什么区别？如何实现？",
        },
        { link: "/js/visible", text: "如何判断一个元素是否在可视区域中？" },
        { link: "/js/continue_to_upload", text: "大文件上传如何做断点续传？" },
        {
          link: "/js/pull_up_loading_pull_down_refresh",
          text: "如何实现上拉加载，下拉刷新？",
        },
        { link: "/js/single_sign", text: "什么是单点登录？如何实现？" },
        { link: "/js/security", text: "web常见的攻击方式有哪些？如何防御？" },
      ],
    },
  ],
  "/es6": [
  ...
  "/typescript/": [
    {
      ...
      items: [
        ...
        {
          link: "/typescript/namespace_module",
  ...
  "/nodeJS": [
    {
      ...
      items: [
        ...
        {
          link: "/nodeJS/require_order",
          text: "说说 Node 文件查找的优先级以及 Require 方法的文件查找策略?",
        },
        {
          link: "/nodeJS/middleware",
  ...
  "/css": [
    {
      ...
      items: [
        ...
        {
          link: "/css/dp_px_dpr_ppi",
          text: "说说设备像素、css像素、设备独立像素、dpr、ppi 之间的区别？",
        },
        {
          link: "/css/hide_attributes",
        ...
        {
          link: "/css/layout_painting",
          text: "怎么理解回流跟重绘？什么场景下会触发？",
        },
        {
          link: "/css/responsive_layout",
          text: "什么是响应式设计？响应式设计的基本原理是什么？如何做？",
        },
        {
          link: "/css/css_performance",
          text: "如果要做优化，CSS提高性能的方法有哪些？",
        },
        {
          link: "/css/single_multi_line",
  ...
  "/applet": [
    {
      ...
      items: [
        ...
        {
          link: "/applet/lifecycle",
          text: "说说微信小程序的生命周期函数有哪些？",
        },
        {
          link: "/applet/navigate",
          text: "说说微信小程序中路由跳转的方式有哪些？区别？",
        },
        {
          link: "/applet/optimization",
  ...
  "/react": [
    {
      ...
      items: [
        ...
        {
          link: "/react/Real DOM_Virtual DOM",
        ...
        {
          link: "/react/class_function component",
          text: "说说对React中类组件和函数组件的理解？有什么区别？",
        },
        {
          link: "/react/controlled_Uncontrolled",
          text: "说说对受控组件和非受控组件的理解？应用场景？",
        },
        {
          link: "/react/High order components",
        ...
        {
          link: "/react/Improve performance",
          text: "说说 React 性能优化的手段有哪些？",
        },
        {
          link: "/react/capture error",
          text: "说说你在React项目是如何捕获错误的？",
        },
        {
          link: "/react/server side rendering",
  ...
  "/webpack": [
    {
      ...
      items: [
        ...
        {
          link: "/webpack/Rollup_Parcel_snowpack_Vite",
  ...
  "/design": [
    {
      ...
      items: [
        ...
        {
          link: "/design/Singleton Pattern",
          text: "说说你对单例模式的理解？如何实现？",
        },
        {
          link: "/design/Factory  Pattern",
          text: "说说你对工厂模式的理解？应用场景？",
        },
        {
          link: "/design/Strategy Pattern",
          text: "说说你对策略模式的理解？应用场景？",
        },
        {
          link: "/design/Proxy Pattern",
          text: "说说你对代理模式的理解？应用场景？",
        },
        {
          link: "/design/Observer  Pattern",
  ...
  "/algorithm": [
    {
      ...
      items: [
        ...
        {
          link: "/algorithm/selectionSort",
          text: "说说你对选择排序的理解？如何实现？应用场景？",
        },
        {
          link: "/algorithm/insertionSort",
          text: "说说你对插入排序的理解？如何实现？应用场景？",
        },
        {
          link: "/algorithm/mergeSort",
        ...
        {
          link: "/algorithm/design1",
          text: "说说说你对分而治之、动态规划的理解？区别？",
        },
        {
          link: "/algorithm/design2",
  ...
  "/linux": [
    {
      ...
      items: [
        ...
        {
          link: "linux/linux users",
          text: "说说你对 linux 用户管理的理解？相关的命令有哪些？",
        },
        {
          link: "linux/redirect_pipe",
